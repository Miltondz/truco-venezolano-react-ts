    ...
    <div id="brisca-screen" className="screen active brisca-screen">
      ...
      {!setupDone && (
        <div className="sm-setup screen-content">
          ...
          <p className="sm-game-desc">Captura cartas de valor con tu triunfo. El palo de triunfo se revela al inicio; las figuras y los ases acumulan los puntos ganadores.</p>
